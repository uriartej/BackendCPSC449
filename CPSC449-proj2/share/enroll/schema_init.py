...
parser.add_argument("-i", "--input", help="Input schema file", default="./share/enroll/schema.sql")
parser.add_argument("-f", "--file", help="SQLite database file", default="./var/enroll/enroll.db")
