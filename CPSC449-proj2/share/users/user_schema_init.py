...
parser.add_argument(
    "-i", "--input", help="Input schema file", default="./share/users/user_service_schema.sql"
)
parser.add_argument("-f", "--file", help="SQLite database file", default="./var/user/primary/fuse/auth.db")
